...
const Navbar = ({}: Props) => {
  return (
    <>
      <Popover className="container mx-auto flex items-center px-6 sm:px-[100px] h-[110px] border-b-[2px]">
        ...
        <div className="grow">
          <div className="hidden font-normal text-sm sm:flex items-center justify-start gap-2 md:gap-[30px] ml-[100px]">
            <Item href={"#explore"} text="EXPLORE" />
            <Item href={"#involved"} text="INVOLVED" />
            <Item href={"#visit"} text="VISIT" />
          </div>
        </div>
            ...
            <div className="bg-white dark:bg-[#222] shadow-lg ring-1 ring-black ring-opacity-5">
              <div className="px-[50px] py-[50px]">
                ...
                <div className="mt-7">
                  <Link
                    href="#visit"
                    className="font-normal text-sm text-[#8C8C8C]"
                  >
                    VISIT US
                  </Link>
                </div>
        ...
        <div className="hidden sm:block">
          <Link href="#visit" className="font-normal text-sm text-[#8C8C8C]">
            VISIT US
          </Link>
        </div>
      </Popover>
